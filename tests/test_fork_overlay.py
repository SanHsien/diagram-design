...
def test_baseline_matches_decisions_record() -> None:
    ...
    # The 2026-08-30 triage filled these in, so the assertion is now the
    # opposite one: all four axes carry a number. Zero stays legitimate --
    # it means the axis was queried and was empty -- so presence and type
    # are what get pinned, not the value.
